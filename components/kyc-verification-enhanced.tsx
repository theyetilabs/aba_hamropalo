...
interface KYCVerificationEnhancedProps {
  locale: "en" | "ne"
}
...
export default function KYCVerificationEnhanced({ locale }: KYCVerificationEnhancedProps) {
            ...
            <CardContent className="pt-12 text-center">
              ...
              <div className="flex gap-4 justify-center">
                ...
                <Button asChild variant="outline">
                  <Link href="/kyc-status">{t.checkStatus}</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <DocumentUpload onFileSelect={handleFileSelect} selectedFile={formData.idFile} locale={locale} />
                </div>
              </div>
            )}
